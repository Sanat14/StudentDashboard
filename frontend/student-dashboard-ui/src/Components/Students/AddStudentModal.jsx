...
export default function AddStudentModal({ isOpen, onClose, onStudentAdded, idToken }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetchWithAuth("http://localhost:5265/api/students", idToken, {
        method: "POST",
        headers: {
